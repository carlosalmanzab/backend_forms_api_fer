...
public record ApiRequestDto(
        ...
        @Schema(description = "Datos de la respuesta que pueden ser de cualquier tipo",
                oneOf = {FormConnectionAuthorizationDto.class,
                        FormAuthorizationProceduresDto.class})
